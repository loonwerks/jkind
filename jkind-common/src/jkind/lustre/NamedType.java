...
public class NamedType extends Type {
    ...
    public static final NamedType INTHOLE = new NamedType("inthole", null);
    public static final NamedType BOOLHOLE = new NamedType("boolhole", null);
    ...
    public static NamedType get(String name) {
        switch (name) {
            ...
            case "inthole":
                return NamedType.INTHOLE;
            case "boolhole":
                return NamedType.BOOLHOLE;
            default:
