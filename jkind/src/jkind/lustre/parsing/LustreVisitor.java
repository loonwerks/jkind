...
public interface LustreVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link LustreParser#baseEID}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by {@link LustreParser#arrayEID}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by {@link LustreParser#recordEID}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
